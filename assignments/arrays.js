...
console.log(find(33, inventory));
//console.log(`Car 33 is a *car year goes here* *car make goes here* *car model goes here*` );


// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
function lastCarInventory(arr){
let lastCar = 0;
        for (i=lastCar;i<arr.length;i++){
                if (arr[i].id === arr.length)
                {
                        return `The last car is a ${arr[i].car_make} ${arr[i].car_model}`
                }
        }
}
console.log(lastCarInventory(inventory));
...
let carModels = [];
        ...
        return JSON.stringify(carModels.sort());
}
...
function years(arr){
        let carYears = [];
                ...
                return JSON.stringify(carYears.sort());
        }
...
console.log(lowYears(inventory)); 
